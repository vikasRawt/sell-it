...
export const NEW_USER_PRODUCT_REQUEST = "NEW_USER_PRODUCT_REQUEST";
export const NEW_USER_PRODUCT_SUCCESS = "NEW_USER_PRODUCT_SUCCESS";
export const NEW_USER_PRODUCT_RESET = "NEW_USER_PRODUCT_RESET";
export const NEW_USER_PRODUCT_FAIL = "NEW_USER_PRODUCT_FAIL";
